...
# Software:
- [Tampermonkey Script = Probot Discord](https://greasyfork.org/en/scripts/461121/code)
- [Python module = Probot OCR and hCAPTCHA Token](https://github.com/noCaptchaAi/python)
