...
For latest plans information visit or apikey: [`dashboard`](https://dash.nocaptchaai.com)
...
|-------|-------------|--------|-------------------------|
| `omgomg` | `1000/$0.2` | `ocr ` | ![omg omg](/omgomg.png) |
| `probot` | `1 request` | `ocr`    | ![probot](/probot.png)|
